...
export const HeaderSection = () => {
  return (
    <header className="bg-[#21b1280d] border-b [border-bottom-style:solid] border-[#0a17481a] flex items-center gap-6 px-6 py-3 relative self-stretch w-full flex-[0_0_auto]">
      <img
      ...
      <div className="flex flex-col items-start gap-2 relative flex-1 grow">
        <h1 className="relative self-stretch mt-[-1.00px] [font-family:'SF_UI_Display-Bold',Helvetica] font-bold text-[#0a1748] text-lg tracking-[-0.50px] leading-[19.8px]">
          Dr. Emily Carter
        </h1>
