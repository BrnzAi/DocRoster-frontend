...
export const NotificationSection = () => {
  return (
    <article className="flex items-center gap-6 px-6 py-3 relative self-stretch w-full flex-[0_0_auto] bg-[#ff3d000d] border-b [border-bottom-style:solid] border-[#0a17481a]">
      <img
        src="/img/ellipse-5-9.png"
        alt="Dr. Emily Greenfield profile"
      ...
      <div className="flex flex-col items-start gap-2 relative flex-1 grow">
        ...
        <p className="relative flex items-center justify-center self-stretch [font-family:'SF_Pro_Text-Semibold',Helvetica] font-normal text-[#ff3d00] text-sm tracking-[-0.41px] leading-[15.4px]">
      ...
      <div className="inline-flex flex-col items-start justify-center gap-2 relative flex-[0_0_auto]">
        <button
          ...
          className="relative w-9 h-9 rounded-[18px] border-[0.5px] border-solid border-[#ffffff14] backdrop-blur-md backdrop-brightness-[100%] [-webkit-backdrop-filter:blur(12px)_brightness(100%)] bg-[linear-gradient(0deg,rgba(255,61,0,1)_0%,rgba(255,61,0,1)_100%)]"
        >
